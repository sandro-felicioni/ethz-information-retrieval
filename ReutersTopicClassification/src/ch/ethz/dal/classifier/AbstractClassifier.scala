...
abstract class AbstractClassifier(restrictedTopics: Set[String], removeStopwords: Boolean, useStemming: Boolean) {
  ...
  protected def getCleanTokens(tokens: List[String]): List[String] = {
